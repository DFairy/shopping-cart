    ...
    <div class="container">
      <div class="checkout-addr">
        ...
        <div class="addr-list-wrap">
          <div class="addr-list">
            <ul>
              <li v-for="(item,index) in sliceAddress" :key='index' :class="{'check':index==currentIndex}" @click="currentIndex=index">
                <dl>
                  <dt>{{item.userName}}</dt>
          ...
          <div class="shipping-addr-more" @click='clickMore'>
        ...
        <div class="shipping-method-wrap">
          <div class="shipping-method">
            <ul>
              <li :class="{'check':wayIndex==1}" @click="wayIndex=1">
                <div class="name">标准配送</div>
                <div class="price">Free</div>
              </li>
              <li :class="{'check':wayIndex==2}" @click="wayIndex=2">
...
export default {
    ...
    computed:{
      sliceAddress(){
        return this.addressList.slice(0,this.listMore)
      },
      ...mapGetters([
        'goods'
      ])
    ...
    methods:{
      clickMore(){
        ...
        this.listMore=this.addressList.length
      },
