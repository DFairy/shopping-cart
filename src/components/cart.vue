                ...
                <li v-for="(item,index) in productList" :key="index">
                  <div class="cart-tab-1">
                    ...
                    <div class="cart-item-pic">
                      <img src="../assets/img/goods-1.jpg">
                    </div>
                    ...
                    <div class="item-include">
                      <dl>
                        <dt>赠送:</dt>
                        <dd v-for="(part,index) in item.parts" :key="index">{{part.partsName}}</dd>
                      </dl>
                    </div>
                  </div>
                    ...
                    <div class="item-quantity">
                      <div class="select-self select-self-open">
                        <div class="quantity">
                          ...
                          <input type="text" value disabled v-model="item.productQuantity">
                          <a href="javascript:void 0" @click="changeMoney(item,-1)">-</a>
                        </div>
                      </div>
                  ...
                  <div class="cart-tab-4">
                    ...
                    >{{item.productPrice*item.productQuantity | fomatMoney}}</div>
                  </div>
          ...
          <div class="cart-foot-wrap">
            ...
            <div class="cart-foot-r">
              <div class="item-total">
                总金额:
                <span class="total-price">{{totalMoney|fomatMoney}}</span>
              </div>
...
<script>
import { cartData } from "@/api/index";
...
export default {
  ...
  created() {
    cartData().then(res => {
      ...
      this.setGoods(this.productList)
    });
  },
  methods: {
